...
(gc "C:\tools\php73\php.ini").replace(';extension=php_curl.dll','extension=php_curl.dll') | sc "C:\tools\php73\php.ini"
(gc "C:\tools\php73\php.ini").replace(';extension=php_gd2.dll','extension=php_gd2.dll') | sc "C:\tools\php73\php.ini"
(gc "C:\tools\php73\php.ini").replace(';extension=php_fileinfo.dll','extension=php_fileinfo.dll') | sc "C:\tools\php73\php.ini"
(gc "C:\tools\php73\php.ini").replace(';extension=php_mbstring.dll','extension=php_mbstring.dll') | sc "C:\tools\php73\php.ini"
